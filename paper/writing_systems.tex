...
\begin{figure*}
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{geo_graphemes.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{geo_phonemes.png}}
...
\begin{figure*}
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{g2p_loss.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{p2g_loss.png}}
...
\begin{figure*}
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{g2p_results.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{p2g_results.png}}
